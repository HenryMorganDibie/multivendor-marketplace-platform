...
export function AppStoreBadge({ href }: { href: string }) {
  return (
    <a
      href={href}
      className="flex items-center gap-1.5 rounded-md border border-white/25 bg-black px-2.5 py-1.5 transition hover:bg-gray-900"
    >
      ...
      <span className="leading-none text-white">
        ...
        <span className="mt-0.5 block text-[11px] font-semibold">App Store</span>
      </span>
    </a>
  );
}
  ...
  return (
    ...
    >
      ...
      <span className="leading-none text-white">
        ...
        <span className="mt-0.5 block text-[11px] font-semibold">Google Play</span>
      </span>
    </a>
  );
}
